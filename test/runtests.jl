...
@testset "Getters" begin
    @timeit TIMEROUTPUT "Getters" begin
...
@testset "IO" begin
    ...
    @testset "uchar" begin
        @timeit TIMEROUTPUT "I/O uchar" begin
            println("input uchar")
    ...
    @testset "char" begin
        @timeit TIMEROUTPUT "I/O char" begin
            println("input char")
    ...
    @testset "int" begin
        @timeit TIMEROUTPUT "I/O int" begin
            println("input int")
    ...
    @testset "float" begin
        @timeit TIMEROUTPUT "I/O float" begin
            println("input float")
    ...
    @testset "complex" begin
        @timeit TIMEROUTPUT "I/O complex" begin
    ...
    @testset "short" begin
        @timeit TIMEROUTPUT "I/O short" begin
            println("input short")
            run(pipeline(pipeline(`$(Madagascar.Madagascar_jll.sfspike()) n1=2 k1=1,2,2
                                        n2=3 k2=1,2,3
                                        nsp=3 mag=1,4,2`,
...
@testset "Prog" begin
    ...
    @testset "rsf_read" begin
        @timeit TIMEROUTPUT "rsf_read" begin
            println("    read")
    ...
    @testset "rsf_write" begin
        @timeit TIMEROUTPUT "rsf_write" begin
            println("    write")
